export default tag Index
	...
	<self[w:100% max-width:940px px:6 px@lt-xs:4]> if web?
		<div[d:vcc w:100% py:12 pt@lt-xs:10 pb@lt-xs:0 pos:relative zi:2]>
			...
			if !S.user
				<a.button.external[mt:8 mt@lt-xs:4 py:2 px:8 px@lt-xs:6 fw:600 fs:2xl fs@lt-xs:xl ta:center c:cooler9 bg:sky9 c:white shadow:xl bg@hover:sky8] href="/login/discord?redirect=/"> "Connect Discord"
